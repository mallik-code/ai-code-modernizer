...
This document provides comprehensive instructions for setting up access to private GitHub repositories when using the AI Code Modernizer application.
...
**Important**: Keep your Personal Access Token secure and never share it publicly. If you suspect a token has been compromised, regenerate it immediately.